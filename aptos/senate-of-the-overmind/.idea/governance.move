module overmind::governance {
    ...
    */
    fun init_module(admin: &signer) {
        ...
        let resource_account_address = account::create_resource_address(&admin_address, SEED);

        // TODO: Register with the aptos_framework::voting module using the GovernanceProposalType and resource account
        voting::register<GovernanceProposalType>(admin);
        ...
        aptos_token::token::create_collection(resource_account_address,
        ...
        mint_governance_token(admin, string::utf8(STARTING_GOVERNANCE_TOKEN_URI),
            resource_account_address, 0, true);

        // TODO: Create the GovernanceConfig object with STARTING_MINIMUM_VOTING_THRESHOLD and 
        //       STARTING_VOTING_DURATION_SECONDS
        create_proposal(admin,
            STARTING_MINIMUM_VOTING_THRESHOLD,
            STARTING_VOTING_DURATION_SECONDS);
    ...
    */
    public entry fun create_proposal(
        ...
        // address_of(proposer)
        let proposer_address = address_of(proposer);
        ...
        let governance_token = check_if_address_is_an_object(proposer_address);
    ...
    */
    ...
    inline fun check_if_address_is_an_object(object_address: address) {
        ...
        assert!(exists<Object<_>>(object_address), EAddressIsNotAnObject);
    }
    ...
    inline fun check_if_account_is_resource_account_address(account_address: address) {
        ...
        assert!(exists(account_address), EAccountIsNotResourceAccount);
